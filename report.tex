...
\end{table}
Trečioji, $x_4$ eilutė lieka nepakitusi, nes pagrindinio stulpelio reikšmė jau yra 0:
\begin{table}[H]
    \centering
    \resizebox{\linewidth}{!}{%
    \begin{tblr}{
...
\begin{table}[H]
    ...
    $C_b$ & $B$            & $X_b$    & $x_1$ & $x_2$ & $x_3$ & $x_4$ & $s_1$ & $s_2$ & $s_3$  \\ 
    \hline
    0     & $s_1$          & 1        & -1    & 1     & -1    & -1    & 1     & 0     & 0      \\ 
    \hline
    0     & $s_2$          & 5       & 2     & 4     & 0     & 0     & 0     & 1     & 0      \\ 
    \hline
    0     & $s_3$          & 7       & 0     & 0     & 1     & 1     & 0     & 0     & 1      \\ 
    \hline
    \multicolumn{3}{|c|}{$Z_j-C_j$}   & 2     & -3    & 0     & -5    & 0     & 0     & 0      \\
    \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    0         & $s_1$ &       &       &       &       &       &       &       &       \\
    0         & $s_2$ &       &       &       &       &       &       &       &       \\
    5         & $x_4$ & 7     & 0     & 0     & 1     & 1     & 0     & 0     & 1     \\
    $Z_j-C_j$ &       &       &       &       &       &       &       &       &       
    \end{tblr}
    }
\end{table}
Kadangi antrosios eilutės pagrindinio stulpelio reikšmė jau yra 0, jai taip pat nereikės atlikti jokių papildomų skaičiavimų:
\begin{table}[H]
    \centering
    \resizebox{\linewidth}{!}{%
    \begin{tblr}{
...
\end{table}
Pirmosios eilutės pagrindinio stulpelio reikšmė yra $-1$, todėl mums tereikia pridėti trečiosios eilutės reikšmes prie pirmosios eilutės:
\begin{table}[H]
    \centering
    \resizebox{\linewidth}{!}{%
    \begin{tblr}{
...
\begin{equation*}
    \frac{7}{0} \not\in \mathbb{R}
\end{equation*}
Antroji eilutė tampa pagrindine. Kadangi pagrindinė reikšmė yra 4, visą pagrindinę eilutę turėsime padauginti iš $\frac{1}{4}$. Štai atnaujinta lentelė:
\begin{table}[H]
    \centering
    \resizebox{\linewidth}{!}{%
    \begin{tblr}{
    ...
    $C_b$     & $B$   & $X_b$ & $x_1$ & $x_2$ & $x_3$ & $x_4$ & $s_1$ & $s_2$ & $s_3$ \\
    0         & $s_1$ &       &       &       &       &       &       &       &       \\
    3         & $x_2$ & 1.25  & 0.5   & 1     & 0     & 0     & 0     & 0.25  & 0     \\
    5         & $x_4$ &       &       &       &       &       &       &       &       \\
    $Z_j-C_j$ &       &       &       &       &       &       &       &       &       
    \end{tblr}
    }
\end{table}
Kadangi trečiosios eilutės pagrindinio stulpelio reikšmė jau yra 0, jokių papildomų skaičiavimų atlikti nereikia:
\begin{table}[H]
    \centering
    \resizebox{\linewidth}{!}{%
    \begin{tblr}{
